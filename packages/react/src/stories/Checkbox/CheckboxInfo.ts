...
const DESCRIPTION = `Checkboxes allow users to select multiple items from a list of individual items, or to mark one individual item as selected.`;
...
const DONT = [
  'Change the colour of the border or background.',
