const TITLE = 'Tabs';
const DESCRIPTION =
  'A segmented control/tabs component is a linear set of two or more segments, each of which functions as a mutually exclusive button. Within the control, all segments are equal in width. <br/>' +
