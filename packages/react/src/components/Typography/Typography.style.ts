...
export const getTypographyColorStyle = ({
  ...
  return {
    dark: {
      ...
      defaultDark: theme.ElementsTextDarkModeDefaultDark,
      defaultLight: theme.ElementsTextDarkModeDefaultLight,
      defaultDarkSecondary: theme.ElementsTextDarkModeDefaultDarkSecondary,
      actionPrimaryDark: theme.ElementsTextDarkModeActionPrimaryDark,
      actionSecondaryLight: theme.ElementsTextDarkModeActionSecondaryLight,
      actionDanger: theme.ElementsTextDarkModeActionDanger,
      disabled: theme.ElementsTextDarkModeDisabled,
      success: theme.ElementsTextDarkModeSuccess,
      successStandalone: theme.ElementsTextDarkModeSuccessStandalone,
      info: theme.ElementsTextDarkModeInfo,
      warning: theme.ElementsTextDarkModeWarning,
      danger: theme.ElementsTextDarkModeDanger,
      dangerError: theme.ElementsTextDarkModeDangerError,
    },
    light: {
